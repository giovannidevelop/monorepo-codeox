package cl.subox.ms.producto.infraestructure.aop;
...
public class RestControllerAspect {
    ...
    @Pointcut("within(cl.subox.ms.producto.infraestructure.controllers..*) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
    ...
    public void logMethod(JoinPoint joinPoint) {
        ...
        try {
            logger.info("{} ==> {} ::: {} ",
                    mapping.method(), mapping.path(), mapper.writeValueAsString(parameters));
    ...
    public void logMethodAfter(JoinPoint joinPoint, ResponseEntity<?> entity) {
        ...
        try {
            logger.info("{} <== {} ::: {}",
                    mapping.method(), mapping.path(), mapper.writeValueAsString(entity));
        } catch (JsonProcessingException e) {
            logger.error("Error while converting", e);
        }
    }
